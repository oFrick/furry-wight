...
public class MainFrame extends JFrame {
	...
	private boolean tartalmaz(DefaultMutableTreeNode mit){
		return selectedNode.isNodeDescendant(mit);
	}
	
	/**Leellenõrzi, hogy a megadott node-ot tartalmazza-e az a megadott könyvtár.
	 * @author Kiss Dániel
	 * @param mit
	 * @return
	 */
	private boolean tartalmaz(DefaultMutableTreeNode mi, DefaultMutableTreeNode mit){
		return mi.isNodeDescendant(mit);
	}
